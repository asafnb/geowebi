...
class Map(ipyleaflet.Map):
    ...
    def __init__(self, center=[32.065, 34.839], zoom=13, **kwargs):
        """Initialize the map.

        Args:
            center (list, optional): Set the center of the map. Defaults to [32.065, 34.839].
            zoom (int, optional): Set the zoom level of the map. Defaults to 13.
        """
